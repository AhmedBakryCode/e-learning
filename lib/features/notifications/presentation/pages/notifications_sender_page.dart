...
class NotificationsSenderPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MultiBlocProvider(
      providers: [
        BlocProvider(create: (_) => sl<NotificationsCubit>()..loadNotifications()),
...
class _NotificationsSenderView extends StatefulWidget {
  ...
  @override
  State<_NotificationsSenderView> createState() => _NotificationsSenderViewState();
}
...
class _NotificationsSenderViewState extends State<_NotificationsSenderView> {
  ...
  final TextEditingController _messageController = TextEditingController(
    text: 'Join today\'s live session with the teacher to review the latest Course updates and ask questions.',
  );
    ...
    return BlocConsumer<NotificationsCubit, NotificationsState>(
      ...
      builder: (context, state) {
        ...
        return AdaptiveScaffold(
          ...
          subtitle: 'Send instant updates to all your students that appear directly on their devices.',
          selectedIndex: 3,
  ...
  Widget _buildForm(bool isSending) {
    return Column(
      ...
      children: [
        AppCard(
          title: 'Alert format',
          subtitle: 'Enter the details of the alert that will be sent to students.',
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
                ...
                builder: (context, state) {
                  return DropdownButtonFormField<String>(
                    ...
                    items: [
                      ...
                      ...state.courses.map((course) => DropdownMenuItem(
                            value: course.id,
                            child: Text(
                              course.title,
        ...
        const InlineFeedbackCard(
          ...
          message: 'Using shortened Zoom links increases student access to the session.',
        ...
        SizedBox(
          ...
          child: FilledButton.icon(
            ...
            label: Text(_selectedCourseId == null ? 'Send now to everyone' : 'Send to Course students'),
          ),
        ),
      ],
    );
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  _messageController.text.isEmpty ? 'Message content...' : _messageController.text,
                  ...
                  children: [
                    for (var i = 0; i < recentNotifications.length; i++) ...[
                      ListTile(
                        ...
                        title: Text(recentNotifications[i].title, overflow: TextOverflow.ellipsis),
                        subtitle: Text(
  ...
  void _send(BuildContext context) {
    ...
    if (title.isEmpty || message.isEmpty) {
      ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text('Title and message are required fields.')));
      return;
    }
